...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapInterests(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.interestsScreen);
  }

  onTapSearchTopics(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchTopicsScreen);
  }
  ...
  onTapInterestsPeople(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.interestsPeopleScreen);
  }
